...
export default function MyInput({ children, width, accName, shap, ...props }) {
  ...
  return (
    <div className={`flex flex-col gap-1.5 ${width || "w-full"} `}>
      <label
        className={`label-text capitalize font-medium text-[16px] md:text-[18px] ${shap ? "text-darky/70" : "text-darky"}`}
      >
