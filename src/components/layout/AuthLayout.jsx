...
export default function AuthLayout() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center px-4 bg-white">
      <div className="w-full max-w-350 py-6 flex">
        <Lang width="w-25" />
      </div>
      <div className="w-full rounded-[30px] flex flex-col lg:flex-row border border-[#9797973D] bg-white shadow-sm overflow-hidden mb-8">
        <div className="hidden lg:block lg:w-1/2 ">
          <MyCarousel high="[900px]" />
        </div>
        <div className="w-full lg:w-1/2 flex justify-center items-center py-12 px-6">
